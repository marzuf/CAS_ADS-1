...
imgDataTrain = zeros(numRows, numCols, 1, numImgs);
for ii = 1:numImgs
    imgDataTrain(:,:,1,ii) = rawImgDataTrain(:,:,ii);
end
...
imgDataTest = zeros(numRows, numCols, 1, numImgs);
for ii = 1:numImgs
    imgDataTest(:,:,1,ii) = rawImgDataTest(:,:,ii);
end
