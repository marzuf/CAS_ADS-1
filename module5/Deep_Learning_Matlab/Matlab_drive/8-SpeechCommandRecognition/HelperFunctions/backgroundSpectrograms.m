...
numHops = round(segmentDuration/hopDuration - 2);
...
% Take the logarithm of the spectrograms with a small offset. This normalizes our data, similar to converting audio amplitude into decibels.
